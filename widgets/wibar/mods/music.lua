...
return function()
    local art       = wibox.widget {
        image = helpers.crop_surface(5.8, gears.surface.load_uncached(beautiful.songdefpicture)),
        opacity = 0.3,
      ...
      playerctl:connect_signal("metadata", function(_, title, artist, album_path, album, new, player_name)
        -- Set art widget
        art.image = helpers.crop_surface(5.8, gears.surface.load_uncached(album_path))
      end)
      ...
      playerctl:connect_signal("playback_status", function(_, playing, player_name)
        play.markup = playing and helpers.colorizeText("󰏤", beautiful.fg_normal) or helpers.colorizeText("󰐊", beautiful.fg_normal)
      end)
